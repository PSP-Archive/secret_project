...
void ProcessKeys(unsigned long xikeys)
{
  ...
  if (xikeys & PSP_CTRL_HOME) memdump();

  if (xikeys & PSP_CTRL_CIRCLE) flashscreen();
...
int main(unsigned int text_addr)
{
  ...
  do
  {
	  ...
	  Print(0, 0, colours[INDEX_WHITE], "- VSH-Exploit DEMO -");
	  changeBuffer();
	  }while(sceKernelDelayThread(1* 1000 * 1000));
  do
  {  
	  sceKernelDelayThread(1* 1000 * 1000);
	  Print(0, 0, colours[INDEX_WHITE], "loading required functions...");
	  changeBuffer();
	  }while(sceKernelDelayThread(2* 1000 * 1000));
	  
  do
   {
 
	   Print(0, 0, colours[INDEX_WHITE], "loading required functions... done");   
       changeBuffer();
	 }while(sceKernelDelayThread(1* 1000 * 1000));
   ...
   {
       Print(0, 0, colours[INDEX_WHITE], "loading required functions... done");   
       Print(0, 1, colours[INDEX_WHITE], "start");
	   changeBuffer();
	 }while(sceKernelDelayThread(1* 1 * 1)); 
  ...
  Print (16,15,colours[INDEX_RED],"    - Hello World Demo -");
  ...
  for(;;)
  {
	 ...
	 Print(0, 0, colours[RANDOM], "Hello World by Darxploit !");
	 Print(0, 2, colours[INDEX_BLUE], "Running via a VSH-EXPLOIT on Firmware 6.20");
	 Print(0, 4, colours[INDEX_BLUE], "Thanks for the tips M0skit0 !");
	 Print(0, 6, colours[INDEX_BLUE], "Press [o] to flash the screen / [/\\] for a screenshot-dump ");
	 Print(0, 8, colours[INDEX_BLUE], "Press HOME to dump the RAM");
	 Print(0, 29, colours[INDEX_RED], "[Beta Version v1.0]");
     Print(0, 10, colours[RANDOM], "And a Happy New Year Sony :P ");
